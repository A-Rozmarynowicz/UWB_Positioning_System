...
Main application entry point and peripheral initialization.  
...
01.\+2026
\end{DoxyDate}
This file contains the primary entry point for the firmware, configures system clocks and peripherals, and starts the application modules.

It provides:\+
\begin{DoxyItemize}
\item System and peripheral initialization (GPIO, DMA, I2C, UART, TIM)
\item Main application loop
\item HAL callback handlers for UART, I2C, and TIM events
\item Error handling routines 
\end{DoxyItemize}
