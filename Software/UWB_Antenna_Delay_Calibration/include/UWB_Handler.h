...
// const uint16_t MANUAL_ANTENNA_DELAY_VALUE = BASE_ANTENNA_DELAY_VALUE + 126;
// const uint16_t MANUAL_ANTENNA_DELAY_VALUE = BASE_ANTENNA_DELAY_VALUE + 125;
const uint16_t MANUAL_ANTENNA_DELAY_VALUE = BASE_ANTENNA_DELAY_VALUE + 97;
// const uint16_t MANUAL_ANTENNA_DELAY_VALUE = BASE_ANTENNA_DELAY_VALUE + 129;
